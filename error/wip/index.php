...
$title = 'wip';
$description = 'fridg3.org is currently undergoing maintenance.';
...
if (!$template_path && $template_name !== 'wip/template.html') {
    $template_path = find_template_file('wip/template.html');
}
if (!$template_path) {
