...
foreach ([
    ...
    'feed' => fridge_feed_render_v2_markdown($markdown),
] as $renderer => $html) {
...
foreach ([mdp_render_markdown($unsafeName), mdp_render_trusted_markdown($unsafeName), fridge_feed_render_v2_markdown($unsafeName)] as $html) {
