...
if (fridge_toast_is_current_user()) $content = fridge_bot_mode_disable_links($content, ['/others/toast-discord-bot']);
$content = fridge_paginate_static_post_list($content, '/others', max(1, (int)($_GET['page'] ?? 1)), 10);
